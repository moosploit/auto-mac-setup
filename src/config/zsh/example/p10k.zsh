# Generated by Powerlevel10k configuration wizard on 2020-09-28 at 14:45 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 8457.
...
#   typeset -g POWERLEVEL9K_SHORTEN_DELIMITER='%F{008} …%F{008}'
  ...
  typeset -g POWERLEVEL9K_IP_INTERFACE='en5'
  # Custom icon.
